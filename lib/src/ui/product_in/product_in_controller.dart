...
class ProductInController extends GetxController {
  static ProductInController get to => Get.find();

  final ProductInRepository repository;
  ProductInController({required this.repository});
