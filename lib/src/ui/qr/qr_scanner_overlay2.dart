  ...
  Path getClip(Size size) {
    return Path()
      ...
      ..addRRect(RRect.fromRectAndRadius(
          Rect.fromCenter(
              center: Offset(size.width / 2, size.height / 2), width: scanArea.width, height: scanArea.height),
...
class QRScannerOverlay2 extends StatelessWidget {
  ...
  QRScannerOverlay2({
    ...
    assert(
      (scanAreaWidth == null && scanAreaHeight == null) || (scanAreaWidth != null && scanAreaHeight != null),
