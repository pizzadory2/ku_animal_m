...
class InputCountExDialog extends StatefulWidget {
  InputCountExDialog({super.key, this.count = 0});

  int count;

  @override
  State<InputCountExDialog> createState() => _InputCounExtDialogState();
}

class _InputCounExtDialogState extends State<InputCountExDialog> {
  ...
  @override
  void initState() {
    _controllerInput.text = widget.count.toString();
  ...
  _buildMain() {
    ...
    String title = "Please enter the quantity";
  ...
  getResultData({bool isCancel = false}) {
    if (_controllerInput.text.isEmpty || isCancel) {
